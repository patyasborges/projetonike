...
import br.inatel.ec206.controller.ListenerPesqMarca;
...
public class PesquisarMarcaView extends JFrame {
	...
	ListenerPesqMarca listener = ListenerPesqMarca.getInstance(this);
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			...
			btnSair.setBounds(204, 350, 115, 45);
