...
import br.inatel.ec206.controller.ListenerPesqCalcado;
...
public class PesquisarCalcadoView extends JFrame {
	...
	ListenerPesqCalcado listener = ListenerPesqCalcado.getInstance(this);
	/**
	 ...
	 * Create the frame.
	 */
	public PesquisarCalcadoView() {
		setTitle("Pesquisar Calcado");
	...
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			...
			btnNewButton.setBounds(116, 475, 83, 73);
