...
import br.inatel.ec206.controller.ListenerPesqArtigDesport;
...
public class PesquisarArtigDesportView extends JFrame {
	...
	ListenerPesqArtigDesport listener = ListenerPesqArtigDesport.getInstance(this);
	 ...
	 * Create the frame.
	 */
	public PesquisarArtigDesportView() {
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			...
			btnSair.setBounds(175, 476, 115, 53);
