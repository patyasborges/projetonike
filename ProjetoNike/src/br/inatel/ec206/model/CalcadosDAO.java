	...
	public void armazenaNovosDados() {
		...
		try {
			...
			conecta._pst = conecta._con.prepareStatement(
					"INSERT INTO calcados(ID_calcado,Descricao_calc,Genero_calc,Tipo_calc, Preco_calc, Tamanho_calc, Cor_calc) VALUES(?,?,?,?,?,?,?)");
			...
			System.out.println("Erro: Conexão Banco! em CALCADOS DAO :(");
		} finally {
